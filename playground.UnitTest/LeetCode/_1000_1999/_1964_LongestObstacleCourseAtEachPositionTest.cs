...
public class _1964_LongestObstacleCourseAtEachPositionTest
{
    [Theory]
    ...
    {
        var actual = _1964_LongestObstacleCourseAtEachPosition.LongestObstacleCourseAtEachPosition(obstacles);
    ...
    {
        var actual = _1964_LongestObstacleCourseAtEachPosition.LongestObstacleCourseAtEachPosition2(obstacles);
        Assert.Equal(expected, actual);
    }
}
