...
public class CanTraverseAllPairsTest
{
    [Theory]
    ...
    public void MaxNumEdgesToRemove(int[] nums, bool expected)
    {
        var actual = CanTraverseAllPairsClass.CanTraverseAllPairs(nums);
